...
public class ManageCustomersFormController {
    ...
    public void btnSave_OnAction(ActionEvent actionEvent) {
        ...
        if (btnSave.getText().equalsIgnoreCase("save")) {
            ...
            try {
                ...
                customerDAO.SaveAllCustomer(new CustomerDTO(id,name,address));
            ...
            try {
                ...
                customerDAO.UpdateAllCustomer(new CustomerDTO(id,name,address));
    ...
    private String generateNewId() {
        try {
            String id1 = customerDAO.generateNextId();
